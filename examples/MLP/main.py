...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='./logs-xent-SP')
    ...
    #         self.fc_1.weight.data /= self.input_mult**0.5
    #         self.fc_1.weight.data *= args.init_std
    #         nn.init.kaiming_normal_(self.fc_2.deepspeed_moe.gate.wg.weight, a=1, mode='fan_in')
    #         self.fc_2.deepspeed_moe.gate.wg.weight.data *= args.init_std
    #         for expert in self.fc_2.deepspeed_moe.experts.deepspeed_experts:
    #             nn.init.kaiming_normal_(expert.weight, a=1, mode='fan_in')
    #             expert.weight.data *= args.init_std
    #         nn.init.zeros_(self.fc_3.weight)
            ...
            for width in widths[:-2]:
                ...
                if args.save_base_shapes:
                    ...
                    delta_shapes = get_shapes(
                        ...
                        MLP(width=width+2, nonlin=nonlin, output_mult=args.output_mult, input_mult=args.input_mult)
                    )
